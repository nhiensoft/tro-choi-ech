...
const PLACE_STYLE = [
  {
    // 1st — Gold
    gradient: "linear-gradient(135deg, #f0cb6a 0%, #d4a843 50%, #b8860b 100%)",
    border: "rgba(212,168,67,0.7)",
    glow: "rgba(212,168,67,0.5)",
    bg: "rgba(212,168,67,0.08)",
    textColor: "#f0cb6a",
    badgeBg: "linear-gradient(135deg, #f0cb6a, #d4a843)",
    badgeText: "#0a0e1a",
    heightClass: "h-72",
  },
  {
    ...
    textColor: "#d0d0d0",
    badgeBg: "linear-gradient(135deg, #e8e8e8, #b0b0b0)",
    badgeText: "#0a0e1a",
    heightClass: "h-60",
  },
  {
    ...
    return (
      <div className="relative flex items-center justify-center min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-3">
          <div className="w-2 h-2 rounded-full animate-gold-pulse" style={{ background: "#d4a843" }} />
          <p style={{ color: "#8a9ab8", fontSize: "1.1rem" }}>Đang chuẩn bị công bố...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen gap-8 p-8 overflow-hidden">
            ...
            return (
              <div
                ...
                style={{
                  background: isRevealed
                    ? `linear-gradient(180deg, rgba(19,24,41,0.98) 0%, rgba(26,32,53,0.98) 100%)`
                    : "rgba(26,32,53,0.5)",
                  border: `2px solid ${isRevealed ? style.border : "rgba(212,168,67,0.1)"}`,
                  boxShadow: isRevealed
                    ? `0 0 30px ${style.glow}, 0 16px 48px rgba(0,0,0,0.6)`
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: isRevealed ? style.gradient : "rgba(212,168,67,0.1)",
                ...
                <div className="aspect-[4/3] bg-card relative overflow-hidden">
                  {teamPhoto ? (
                    <img
                      ...
                      style={{
                        filter: isRevealed ? "blur(0) brightness(1)" : "blur(16px) brightness(0.5)",
                    ...
                    <div
                      ...
                      style={{ background: isRevealed ? style.bg : "rgba(19,24,41,0.8)" }}
                    >
                      {isRevealed ? (
                        <svg
                          width="56"
                        ...
                        >
                          <path d="M18 10 L18 38 Q18 54 40 56 Q62 54 62 38 L62 10 Z" fill="rgba(212,168,67,0.2)" stroke="#d4a843" strokeWidth="2" />
                          <path d="M18 18 Q6 18 6 28 Q6 40 18 38" fill="none" stroke="#d4a843" strokeWidth="2" strokeLinecap="round" />
                          <path d="M62 18 Q74 18 74 28 Q74 40 62 38" fill="none" stroke="#d4a843" strokeWidth="2" strokeLinecap="round" />
                          <rect x="26" y="56" width="28" height="4" rx="2" fill="#d4a843" opacity="0.6" />
                          <rect x="22" y="60" width="36" height="5" rx="2.5" fill="#d4a843" opacity="0.8" />
                          <path d="M40 18 L42 25 L49 25 L43.5 29.5 L45.5 36 L40 31.5 L34.5 36 L36.5 29.5 L31 25 L38 25 Z" fill="#d4a843" />
                        </svg>
                      ) : (
                        <span
                          className="font-bold"
                          style={{ color: "rgba(212,168,67,0.3)", fontSize: "3rem" }}
                        >
                          ?
                        </span>
                      )}
                  ...
                  <div
                    ...
                    style={{
                      background: isRevealed ? style.badgeBg : "rgba(19,24,41,0.8)",
                      color: isRevealed ? style.badgeText : "rgba(138,154,184,0.5)",
                      border: isRevealed ? "none" : "1px solid rgba(212,168,67,0.15)",
                ...
                >
                  <p
                    ...
                    style={{
                      color: isRevealed ? style.textColor : "#8a9ab8",
                  ...
                  {isRevealed && score !== undefined && (
                    <p style={{ color: "#8a9ab8", fontSize: "0.85rem" }} className="mt-1">
                      {score} điểm
                    </p>
                  )}
                </div>
      ...
      {isFirstRevealed && (
        <div
          ...
          style={{
            background: "radial-gradient(ellipse 80% 70% at 50% 50%, rgba(212,168,67,0.08) 0%, rgba(10,14,26,0.97) 70%)",
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center gap-8 text-center px-8">
            ...
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #f0cb6a, #d4a843, #b8860b)",
                color: "#0a0e1a",
              }}
            >
              {PLACE_LABELS[0]}
            ...
            {state.teamPhotos?.[firstIdx] ? (
              <div
                ...
                style={{
                  border: "3px solid rgba(212,168,67,0.8)",
                }}
              >
                <img
              ...
              <svg
                ...
                aria-hidden="true"
              >
                <path d="M18 10 L18 38 Q18 54 40 56 Q62 54 62 38 L62 10 Z" fill="rgba(212,168,67,0.25)" stroke="#d4a843" strokeWidth="2.5" />
                <path d="M18 18 Q6 18 6 28 Q6 40 18 38" fill="none" stroke="#d4a843" strokeWidth="2.5" strokeLinecap="round" />
                <path d="M62 18 Q74 18 74 28 Q74 40 62 38" fill="none" stroke="#d4a843" strokeWidth="2.5" strokeLinecap="round" />
                <rect x="26" y="56" width="28" height="4" rx="2" fill="#d4a843" opacity="0.7" />
                <rect x="22" y="60" width="36" height="5" rx="2.5" fill="#d4a843" />
                <path d="M40 18 L42 25 L49 25 L43.5 29.5 L45.5 36 L40 31.5 L34.5 36 L36.5 29.5 L31 25 L38 25 Z" fill="#d4a843" />
              </svg>
            )}
